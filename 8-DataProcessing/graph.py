...
axes.set_title("График заряда-разряда конденсатора в RC-цепи", fontsize=20)

# axes.plot(time_arr, volt_arr, color='blue')
...
# print(charge_time, discharge_time)
...
axes.text(x=(charge_time/2-0.8), y=volt_max/2, s=("Время зарядки: " + str(round(charge_time, 2)) + " с"), color='blue', fontsize=14)
axes.text(x=(charge_time+discharge_time/2-0.8), y=volt_max/2, s=("Время разрядки: " + str(round(discharge_time, 2)) + " с"), color='red', fontsize=14)
